...
#define C_PREF DenKrement_plugin_network_topology_discovery
...
{
	ThreadManager* thrall = (((struct network_topology_discovery_ThreadArgPassing *)arg)->thrall);
	struct ShMemHeader *shmem_headers = (((struct network_topology_discovery_ThreadArgPassing *)arg)->shmem_headers);
	DenKr_essentials_ThreadID ownID = (((struct network_topology_discovery_ThreadArgPassing *)arg)->ownID);
	DenKr_essentials_ThreadID mainThreadID = (((struct network_topology_discovery_ThreadArgPassing *)arg)->mainThreadID);
	free(arg);
	int err;
...
//	CREATE_PROGRAM_PATH_REUSE(*argvg);
	...
	printfc(DENKR__COLOR_ANSI__THREAD_BASIC,"Thread:");printf(" Network Topology Discovery started.\n");
	...
	printf("is closing: DenKrement_plugin_network_topology_discovery.\n");
...
{
	int err;
	int role=DenKr_plugin_role__network_topology_discovery;
